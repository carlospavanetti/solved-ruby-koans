...
"watch" the koans for changes (in the original koans repository, it is recommended to use +watchr+ gem, but it has an issue corrected by +observr+ and it is not maintained anymore):
